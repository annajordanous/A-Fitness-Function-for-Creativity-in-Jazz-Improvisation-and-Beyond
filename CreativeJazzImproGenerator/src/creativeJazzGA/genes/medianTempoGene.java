...
public class medianTempoGene extends IntegerGene  implements Gene, java.io.Serializable {
	/**
	 * 
	 */
	...
	public medianTempoGene(Configuration aConfiguration, int lowerBound, int upperBound)
	...
	public Gene newGene()  {
		Gene newGene = null;
		try {
			newGene = new medianTempoGene(conf, m_lowerBounds, m_upperBounds);
	 ...
	 /**
	  ...
	  public String toString() {
	    String s = "medianTempoGene(" + m_lowerBounds + "," + m_upperBounds + ")"
	        + "=";
